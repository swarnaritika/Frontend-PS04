...
const NotFound = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="text-center max-w-md glass-card p-12 border-black">
        ...
        <Link to="/">
          <Button size="lg" className="rounded-none bg-gradient-hero border-0 hover:opacity-90 shadow-glass">
