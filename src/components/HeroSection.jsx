    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-none  text-primary font-medium text-sm mb-6 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Donate Hope,{" "}
            <span className="text-black">Transform Lives</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <Link to="/auth?role=donor">
              <Button size="lg" className="h-14 px-8 rounded-none text-lg bg-[#FFCC00] border-0 hover:opacity-90 shadow- group">
                Start Donating
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Link to="/auth?role=recipient">
              <Button size="lg" variant="outline" className="h-14 px-8 rounded-none text-lg  hover:-translate-y-1 hover:shadow-none">
                Request Assistance
              </Button>
            </Link>
          </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {[
              ...
              <div key={i} className=" p-6 hover:-translate-y-1 hover:shadow-none transition-all duration-300 group">
